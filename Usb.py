...
class Usb:
    ...
    def request(self, data, data_len):
        ...
        logging.info("cerrando conexion entrante")
        logging.info(self.api._MPUSBClose(pin))
        logging.info("cerrando conexion salida")
        logging.info(self.api._MPUSBClose(pout))
